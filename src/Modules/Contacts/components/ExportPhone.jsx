export const ExportPhone = () => {
    return(
        <div className="export_phone">
            <div className="contacts_title">
                Реализация торфяных топливных брикетов на экспорт: УП "Брестоблгаз" ул. Генерала Попова, 16, 224012, г. Брест
            </div>
            <div className="line"></div>
            <div className="contacts_phone_subtitle">
